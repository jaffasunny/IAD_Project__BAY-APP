    ...
    <div>
      <Container
        ...
        <ThemeProvider theme={theme}>
          ...
          <Grid container spacing={4} sx={{ height: "50%" }}>
              ...
              <Card
                ...
                <CardContent sx={{ p: 1, pb: 2 }}>
                  <Typography variant='body2' color='text'>
                    Welcome to Bay App! <br />
                    <br />
                    These terms and conditions outline the rules and regulations
                    for the use of Bay App's Website, located at
                    https://bayapp.netlify.app/. <br />
                    <br />
                    By accessing this website we assume you accept these terms
                    and conditions. Do not continue to use Bay App if you do not
                    ...
                    We employ the use of cookies. By accessing Bay App, you
                    agreed to use cookies in agreement with the Bay App's
                    ...
                    <br />
                    <br /> Some of our affiliate/advertising partners may also
                    use cookies. License Unless otherwise stated, Bay App and/or
                    its licensors own the intellectual property rights for all
                    material on Bay App. All intellectual property rights are
                    reserved. You may access this from Bay App for your own
                    personal use subjected to restrictions set in these terms
                    and conditions. You must not: Republish material from Bay
                    App Sell, rent or sub-license material from Bay App
                    Reproduce, duplicate or copy material from Bay App
                    Redistribute content from Bay App This Agreement shall begin
                    on the date hereof. Our Terms and Conditions were created
                    ...
                    the website. Bay App does not filter, edit, publish or
                    review Comments prior to their presence on the website.
                    Comments do not reflect the views and opinions of Bay
                    App,its agents and/or affiliates. Comments reflect the views
                    and opinions of the person who post their views and
                    opinions. To the extent permitted by applicable laws, Bay
                    App shall not be liable for the Comments or for any
                    liability, damages or expenses caused and/or suffered as a
                    result of any use of and/or posting of and/or appearance of
                    the Comments on this website. Bay App reserves the right to
                    ...
                    the linking party’s site. We may consider and approve other
                    ...
                    compensates the absence of Bay App; and (d) the link is in
                    the context of general resource information. These
                    ...
                    e-mail to Bay App. Please include your name, your
                    ...
                    uniform resource locator being linked to; or By use of any
                    other description of our Website being linked to that makes
                    sense within the context and format of content on the
                    linking party’s site. No use of Bay App's logo or other
                    artwork will be allowed for linking absent a trademark
                    license agreement. iFrames Without prior approval and
                    written permission, you may not create frames around our
                    Webpages that alter in any way the visual presentation or
                    appearance of our Website. Content Liability We shall not be
                    hold responsible for any content that appears on your
                    Website. You agree to protect and defend us against all
                    claims that is rising on your Website. No link(s) should
                    ...
                    to and follow these linking terms and conditions. Removal of
                    links from our website If you find any link on our Website
                    that is offensive for any reason, you are free to contact
                    and inform us any moment. We will consider requests to
                    remove links but we are not obligated to or so or to respond
                    to you directly. We do not ensure that the information on
                    this website is correct, we do not warrant its completeness
                    or accuracy; nor do we promise to ensure that the website
                    remains available or that the material on the website is
                    kept up to date. Disclaimer To the maximum extent permitted
                    by applicable law, we exclude all representations,
                    warranties and conditions relating to our website and the
                    use of this website. Nothing in this disclaimer will: limit
                    or exclude our or your liability for death or personal
